...
public class SetGoals extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater,
		...
		Cursor bodyStats = MainActivity.db.rawQuery("SELECT * FROM User WHERE UserID = 2", null);
		
		while(bodyStats.moveToNext()){
			etWeight.setText(DatabaseUltility.GetColumnValue(bodyStats, DatabaseUltility.Weight));
			etBodyFat.setText(DatabaseUltility.GetColumnValue(bodyStats, DatabaseUltility.BodyFat));
			etHeight.setText(DatabaseUltility.GetColumnValue(bodyStats, DatabaseUltility.Height));
			etChest.setText(DatabaseUltility.GetColumnValue(bodyStats, DatabaseUltility.Chest));
			etWaist.setText(DatabaseUltility.GetColumnValue(bodyStats, DatabaseUltility.Waist));
			etArms.setText(DatabaseUltility.GetColumnValue(bodyStats, DatabaseUltility.Arms));
			etShoulders.setText(DatabaseUltility.GetColumnValue(bodyStats, DatabaseUltility.Shoulders));
			etForearms.setText(DatabaseUltility.GetColumnValue(bodyStats, DatabaseUltility.Forearms));
			etNeck.setText(DatabaseUltility.GetColumnValue(bodyStats, DatabaseUltility.Neck));
			etHips.setText(DatabaseUltility.GetColumnValue(bodyStats, DatabaseUltility.Hips));
			etThighs.setText(DatabaseUltility.GetColumnValue(bodyStats, DatabaseUltility.Thighs));
			etCalves.setText(DatabaseUltility.GetColumnValue(bodyStats, DatabaseUltility.Calves));
		}
